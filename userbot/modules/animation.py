...
@register(outgoing=True, pattern="^.mylove$")
async def koc(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("I LOVEE YOUUU 💕")
        await e.edit("💝💘💓💗")
        ...
        await e.edit("💕💞💘💝")
        await e.edit("💘💕💞💝")
        await e.edit("Linzy, AKU SAYANG KAMU💞")
...
async def _(event):
    ...
    if input_str == "cintaku":
        ...
        animation_chars = [
            ...
            "`Mengirim Cintaku.. 84%\n█████████████████████▒▒▒▒ `",
            "`Mengirim Cintaku.. 100%\n█████████CINTAKU███████████ `",
            f"`Cintaku Sekarang Sepenuhnya Terkirim Padamu, Dan Sekarang Aku Sangat Mencintai Mu, Linzy, I Love You 💞`",
        ]
