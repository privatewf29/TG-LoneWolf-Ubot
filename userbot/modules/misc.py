...
async def killdabot(event):
    ...
    await event.edit("`Mematikan TG-LoneWolf-Ubot....`")
...
async def killdabot(event):
    await event.edit("`Restarting TG-LoneWolf-Ubot...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID, "#RESTARTBOT \n" "`TG-LoneWolf-Ubot Telah Di Restart`"
        )
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[TG-LoneWolf-Ubot](https://github.com/W29F/TG-LoneWolf-Ubot/blob/TG-LoneWolf-Ubot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        f"**Hey**, __I am using__ ♥ **TG-LoneWolf-Ubot** ♥\n\n"
        f"      __Thanks For Using me__\n\n"
        f"ღ **Userbot Version :** `4.1@TG-LoneWolf-Ubot`\n"
        f"ღ **Group Support :** [Sharing Userbot](t.me/privatener)\n"
        f"ღ **Owner Repo :** [NerSup](t.me/privatener)\n"
        f"ღ **Repo :** [TG-Lonwolf](https://github.com/W29F/TG-LoneWolf-Ubot)\n"
    )
...
async def repo_is_here(wannasee):
    """ For .repo command, just returns the repo URL. """
    await wannasee.edit(
        f"ღ **GET STRING SESSION TELEGRAM :** [KLIK DISINI](https://replit.com/@ErichDaniken/Generate-Telegram-String-Session)\n"
    )
...
CMD_HELP.update(
    {
        "sleep": "**Plugin : **`sleep`\
        \n\n  •  **Syntax :** `.sleep`\
        \n  •  **Function : **Biarkan TG-Lonwolf tidur selama beberapa detik \
    "
    }
)
...
CMD_HELP.update(
    {
        "repo": "**Plugin : **`Repository TG-LoneWolf-Ubots`\
        \n\n  •  **Syntax :** `.repo`\
        \n  •  **Function : **Menampilan link Repository TG-LoneWolf-Ubot\
        \n\n  •  **Syntax :** `.string`\
        \n  •  **Function : **Menampilan link String TG-LoneWolf-Ubot\
    "
    }
)
