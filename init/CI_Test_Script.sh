...
tg_sendinfo "<code>I am gonna merge staging into TG-LoneWolf-Ubot</code>"
cd
...
git push --force origin staging:TG-LoneWolf-Ubot
tg_sendinfo "<code>I have merged all commits from staging into TG-LoneWolf-Ubot/code>"
